...
>
    ...
    >
                ...
                <div class="hurryt-flex">
                    ...
                    <div class="hurryt-flex-grow">
                        <select name="recurring_frequency" id="hurrytRecurringFrequency"
                            ...
                            <option value="<?php echo C::RECURRING_MONTHLY ?>"
                                <?php echo selected($campaign->recurringFrequency, C::RECURRING_MONTHLY) ?>>
                                Month(s)
                            </option>
                        </select>
                    </div>
        ...
        <tr class="form-field">
            <td>
                <label><?php _e('Start Date/Time', "hurrytimer") ?> <span
                            ...
                            class="hurryt-icon" data-icon="help" style="vertical-align: middle;"></span></label>
            </td>
            <td>
    ...
    <td>
                ...
                <label class="hurryt-mr-3 hurryt-text-md">
                    <input type="radio"
                           name="recurring_monthly_day_type"
                           value="<?php echo C::RECURRING_MONTHLY_DAY_OF_MONTH ?>"
                        <?php checked( $campaign->recurringMonthlyDayType, C::RECURRING_MONTHLY_DAY_OF_MONTH ) ?>
                    >
                ...
                <label class="hurryt-mr-3 hurryt-text-md">
                    <input type="radio"
                           name="recurring_monthly_day_type"
                           value="<?php echo C::RECURRING_MONTHLY_DAY_OF_WEEK ?>"
                        <?php checked( $campaign->recurringMonthlyDayType, C::RECURRING_MONTHLY_DAY_OF_WEEK ) ?>
                    >
